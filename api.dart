...
class ApiService {
  static const String baseUrl = 'https://crudcrud.com/api/2a728d20a9cc4b7f8a88d83ece3ff788/students/courses'; // Replace with your API URL
...
static Future<void> saveStudents(Map<String, Student> students) async {
  try {
    ...
    if (response.statusCode != 201) {
      ...
      print('Data saved successfully for students.');
    }
  } catch (e) {
...
static Future<void> saveCourses(Map<String, Course> courses) async {
  try {
    ...
    if (response.statusCode != 201) {
      ...
      print('Data saved successfully for courses.');
    }
  } catch (e) {
